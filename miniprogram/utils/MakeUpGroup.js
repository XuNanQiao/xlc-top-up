...
exports.MakeUpGroup = void 0;
var WebClient_1 = require("./WebClient");
var setting_1 = require("../setting");
var MakeUpGroup = /** @class */ (function (_super) {
    __extends(MakeUpGroup, _super);
    function MakeUpGroup() {
        return _super.call(this, setting_1.setting.apiEndPoint) || this;
    }
    //获取拼团信息列表
    MakeUpGroup.prototype.GetMakeGroupList = function (page, PageSize) {
    ...
    //获取助力信息列表
    MakeUpGroup.prototype.GetPowerAssistDTO = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    /*** 获得 活动列表*/
    MakeUpGroup.prototype.getInteractActivityListAsync = function (pageIndex, pageSize, q, vipType, kind, zyId, topType) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = this.combin({ pageIndex: pageIndex, pageSize: pageSize, kind: 3 }, { q: q, vipType: vipType, zyId: zyId, topType: topType });
    ...
    /*** 获取课程活动信息*/
    MakeUpGroup.prototype.getTopicListAsync = function (page, kind) {
...
exports.MakeUpGroup = MakeUpGroup;
