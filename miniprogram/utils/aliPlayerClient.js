...
exports.AliPlayerClient = void 0;
var WebClient_1 = require("./WebClient");
var setting_1 = require("../setting");
var AliPlayerClient = /** @class */ (function (_super) {
    __extends(AliPlayerClient, _super);
    function AliPlayerClient() {
    ...
    */
    AliPlayerClient.prototype.getVideoSegmentList = function (PageIndex, PageSize, id, videoType) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = this.combin({ PageIndex: PageIndex, PageSize: PageSize }, { id: id, videoType: videoType });
    ...
    //获取播放凭证
    AliPlayerClient.prototype.getVideoPlayAuth = function (VideoId) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    //检查是或否存在分段视频列表
    AliPlayerClient.prototype.cheackIsSegment = function (id, videoType) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return AliPlayerClient;
}(WebClient_1.WebClient));
exports.AliPlayerClient = AliPlayerClient;
