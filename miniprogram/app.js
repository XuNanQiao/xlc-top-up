...
App({
    ...
    reloadCurrent: function (Options) {
        var pages = getCurrentPages();
        var currPage = pages[pages.length - 1]; //当前页面 
        if (Options) {
            currPage.setData({
    ...
    dateShow: function (time) {
        ...
        else if (new Date(time).toLocaleDateString() ==
    ...
    countDown: function (dateVal, date2Val) {
        return __awaiter(this, void 0, void 0, function () {
            var date1, date2 //结束时间
            , date3, days, leave1, hours, leave2, minutes, leave3, seconds, time;
            return __generator(this, function (_a) {
                ...
                date3 = new Date(date1).getTime() - new Date(date2).getTime();
