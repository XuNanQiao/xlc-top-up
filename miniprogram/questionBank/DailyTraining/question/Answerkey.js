            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, examPackageClient.getDailyTrainingQusetion((_a = this.data.userInfo) === null || _a === void 0 ? void 0 : _a.id, this.data.onKcItem.id)];
                    case 1:
                        responseAnalysis = _b.sent();
                        for (i in responseAnalysis.items) {
                            responseAnalysis.items[i].answer = stringHelper_1.ImgSizeLimit(responseAnalysis.items[i].answer);
                        }
