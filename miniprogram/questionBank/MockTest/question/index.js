...
Page({
    ...
    getExamQusetionList: function () {
        ...
        if (this.data.userInfo) {
            examPackageClient.getAppExamRoomObj(parseInt(this.data.roomId), parseInt(this.data.roomExamId), this.data.userInfo.id).then(function (res) {
                if (res.data) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, webClient.sendAsync({
                                ...
                                if (res.data) {
                                    wx.navigateTo({
                                        url: "/questionBank/MockTest/question/Answerkey?roomId=" + _this.data.roomId + "&examId=" + _this.data.examId
                                    });
                                }
                                else {
                                    wx.showToast({
